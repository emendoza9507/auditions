...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Auditions - Jazz Hamilton Foundation</title>
    ...
    <section class="repertoire">
        ...
        <div  style="text-align:center; height: 300px;overflow:hidden;background-position: center; background-image: url('https://plus.unsplash.com/premium_photo-1683219368443-cb52cb4bf023?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
            <!-- <img style="width:100%; object-fit:cover; object-position: center" src="https://plus.unsplash.com/premium_photo-1683219368443-cb52cb4bf023?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Child performing on stage" style="max-width:100%; border-radius:10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"> -->
        </div>
    ...
    <footer>
        ...
        <div style="display: flex; flex-direction: column">
            <a style="color:white" href="mailto:  auditions@jhartsfoundation.com">auditions@jhartsfoundation.com</a>
